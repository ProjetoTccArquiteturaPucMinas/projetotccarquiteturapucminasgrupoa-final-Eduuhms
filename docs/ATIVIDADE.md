...
## Sua tarefa
1. Identificar a arquitetura usada no projeto. --> Arquitetura de camadas 
2. Justificar com base na estrutura do código. --> Devido à divisão característica em camadas, sendo elas: Apresentação, Persistência, Serviço e Modelo
3. Identificar a classe que deve ser alterada --> `ServicoCarrinho`
